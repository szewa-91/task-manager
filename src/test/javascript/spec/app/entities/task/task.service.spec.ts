...
import { ITask, Task, Priority, TaskStatus } from 'app/shared/model/task.model';
...
describe('Service Tests', () => {
    describe('Task Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Task(0, 'AAAAAAA', currentDate, currentDate, Priority.TOP, TaskStatus.CREATED);
        });
