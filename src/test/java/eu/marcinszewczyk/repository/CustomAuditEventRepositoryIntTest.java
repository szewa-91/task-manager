package eu.marcinszewczyk.repository;

import eu.marcinszewczyk.TaskManagerApp;
import eu.marcinszewczyk.config.Constants;
import eu.marcinszewczyk.config.audit.AuditEventConverter;
import eu.marcinszewczyk.domain.PersistentAuditEvent;
...
import static eu.marcinszewczyk.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
