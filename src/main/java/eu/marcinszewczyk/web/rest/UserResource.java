...
import eu.marcinszewczyk.web.rest.errors.EmailAlreadyUsedException;
import eu.marcinszewczyk.web.rest.errors.LoginAlreadyUsedException;
import eu.marcinszewczyk.web.rest.util.HeaderUtil;
import eu.marcinszewczyk.web.rest.util.PaginationUtil;
