package eu.marcinszewczyk.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(eu.marcinszewczyk.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(eu.marcinszewczyk.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
